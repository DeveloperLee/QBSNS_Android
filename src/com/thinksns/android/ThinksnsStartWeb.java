...
/**
 * 显示注册和新浪微博授权的网页页面的Activity 现版本暂时不支持注册和新浪微博授权。
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 private class HelloWebViewClient extends WebViewClient { 
			...
			public void onPageFinished(WebView view, String url) {
				...
				Log.e("url","url"+url);
				/*if(url.equals("http://dev.thinksns.com/ts/2.0/index.php?app=wap&mod=Public&act=login")){
					Intent intent =new Intent(ThinksnsStartWeb.this, ThinksnsActivity.class);
...
//					ThinksnsStartWeb.this.finish();
//				}
				Pattern pattern =Pattern.compile( "(oauth_token=(.+?)&)|(uid=(.+?)&)|(oauth_token_secret=(.+?)&)");
			//	Pattern pattern =Pattern.compile( "(oauth_token=(.+?)&)|(oauth_token_secret=(.+?)&)");
	 ...
	 private  class ActivityHandler extends Handler{
		 ...
		 private static final long SLEEP_TIME = 2000;
			...
			public void handleMessage(Message msg) {
				...
				authorizeResult.setSecretToken(msg.getData().getString("oauth_token_secret"));
